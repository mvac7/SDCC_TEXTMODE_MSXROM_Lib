/* =============================================================================
# TEXTMODE_MSXBIOS Library (fR3eL Project)
...
- v1.5 (24/02/2024) 
	- bchput recovery
	- Added GetColumns, GetCursorRow and GetCursorColumn
- v1.4 (24/11/2023) 
...
TMODE_Num2$:
	...
	cp   #48				//"0" ASCII code
	jr   NZ,TMODE_Num3$		//if A!=48 then goto TMODE_Num3$
...
TMODE_Num4$:
	...
	dec  A					//number Digit
	cp   E					//length
	jr   NC,TMODE_next5$	//IF num.Digit>length THEN dont print
